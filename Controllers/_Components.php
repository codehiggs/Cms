...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:42:50
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Controllers\_Components.php]
...
class Components extends ModuleController
{
    ...
    {
        $url = base_url('cms/components/home/' . lpk());
    ...
    public function home(string $rnd)
    {
        ...
        $this->component = $this->views . '\Components\Home';
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Components\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Components\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Components\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Components\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Components\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
