...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:44:47
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Controllers\_Typefiles.php]
...
class Typefiles extends ModuleController
{
    ...
    {
        $url = base_url('cms/typefiles/home/' . lpk());
    ...
    public function home(string $rnd)
    {
        ...
        $this->component = $this->views . '\Typefiles\Home';
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Typefiles\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Typefiles\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Typefiles\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Typefiles\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Typefiles\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
