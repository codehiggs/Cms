...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:42:22
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Controllers\_Asigns.php]
...
class Asigns extends ModuleController
{
    ...
    {
        $url = base_url('cms/asigns/home/' . lpk());
    ...
    public function home(string $rnd)
    {
        ...
        $this->component = $this->views . '\Asigns\Home';
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Asigns\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Asigns\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Asigns\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Asigns\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Asigns\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
