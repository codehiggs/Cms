...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:42:40
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Blocks\Creator\form.php]
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["block"] . $f->fields["name"] . $f->fields["description"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["area"] .)));
...
$card = $b->get_Card("create", array(
    "title" => lang("Blocks.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
