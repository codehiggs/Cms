...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:42:25
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Asigns\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["asign"] = $f->get_Value("asign");
$r["post"] = $f->get_Value("post");
$r["meta"] = $f->get_Value("meta");
...
$f->fields["asign"] = $f->get_FieldText("asign", array("value" => $r["asign"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["post"] = $f->get_FieldText("post", array("value" => $r["post"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["meta"] = $f->get_FieldText("meta", array("value" => $r["meta"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["asign"] . $f->fields["post"] . $f->fields["meta"])));
...
$card = $b->get_Card("create", array(
    "title" => lang("Asigns.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
