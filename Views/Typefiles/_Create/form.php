...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:44:52
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Typefiles\Creator\form.php]
...
$r["typemime"] = $f->get_Value("typemime");
...
$f->fields["typemime"] = $f->get_FieldText("typemime", array("value" => $r["typemime"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["typemime"] .)));
...
$card = $b->get_Card("create", array(
    "title" => lang("Typefiles.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
