...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:43:17
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Links\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["link"] = $f->get_Value("link");
$r["post"] = $f->get_Value("post");
$r["text"] = $f->get_Value("text");
$r["target"] = $f->get_Value("target");
...
$f->fields["link"] = $f->get_FieldText("link", array("value" => $r["link"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["post"] = $f->get_FieldText("post", array("value" => $r["post"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["text"] = $f->get_FieldText("text", array("value" => $r["text"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["link"] . $f->fields["post"] . $f->fields["text"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["target"] . $f->fields["description"] .)));
