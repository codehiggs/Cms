...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:42:53
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Components\Creator\form.php]
...
//[services]------------------------------------------------------------------------------------------------------------
$b = service("bootstrap");
$f = service("forms", array("lang" => "Cms_Components."));
...
$f->fields["widget"] = $f->get_FieldText("widget", array("value" => $r["widget"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["component"] . $f->fields["post"] . $f->fields["widget"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["block"] .)));
...
$card = $b->get_Card("create", array(
    "title" => lang("Components.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
